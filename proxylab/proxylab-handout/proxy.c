 ...
 * I used a struct to save the data of cache, and two arrays
...
void cache_read(int index, char *dst);
...
void *thread(void *p)
{
    ...
    if (length < 0) {
        // if failed
        clienterror(connfd, method, "501", "No content-length",
